...
import { buildEmailWatermarkHtml, buildEmailFooterHtml } from '@/lib/email-watermark';
...
export async function POST(req: Request) {
    try {
        ...
        const planTier = quotaContext?.planTier ?? "free"
        const watermarkHtml = buildEmailWatermarkHtml({
            planTier,
